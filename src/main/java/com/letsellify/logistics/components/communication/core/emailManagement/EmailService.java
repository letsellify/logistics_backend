package com.letsellify.logistics.components.communication.core.emailManagement;
...
public class EmailService {
    ...
    @Async
    public void sendLogisticRequestedMailToDispatchers(final LogisticRequestBroadcast broadcast, final Set<Dispatcher> dispatchers) {
    ...
    @Async
    public void sendLogisticRequestedMailToAgents(final LogisticRequestBroadcast broadcast, final Set<Agent> agents) {
        for (final Agent agent : agents) {
            this.sendLogisticRequestEmail(agent.email(), agent.name(), broadcast, "https://letsellify.com/agent-dashboard");
        }
    }
