package com.letsellify.logistics.components.user.core.socialSignupAndLoginManagement.config;
...
//        this.addSecurityHeaders(response);
        ...
        if (appUser.getRole() == null) {
            ...
            CookieHandler.addCookie(response, domain, "access_token", securityToken.getAccessToken(), 15 * 60);
            CookieHandler.addCookie(response, domain,"refresh_token", securityToken.getRefreshToken(), 7 * 24 * 60 * 60);
            this.addSecurityHeaders(response);
