package com.letsellify.logistics.components.user.core.verificationCodeManagement.database.entity;
...
public class VerificationCodeEntity extends Auditable {
    ...
    public VerificationCodeEntity(final String userEmail, final LogisticsAppRole role) {
        super();
