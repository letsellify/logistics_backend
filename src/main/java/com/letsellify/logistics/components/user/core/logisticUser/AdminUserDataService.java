...
public class AdminUserDataService {
    ...
    public LogisticDispatcherResource approveDispatcher(final @NonNull String dispatcherEmail) {
        try {
    ...
    public LogisticAgentInfoResource viewAgentPersonalInfo(final @NonNull String dispatcherEmail) {
        try {
    ...
    public LogisticAgentResource approveAgent(final @NonNull String dispatcherEmail) {
        try {
