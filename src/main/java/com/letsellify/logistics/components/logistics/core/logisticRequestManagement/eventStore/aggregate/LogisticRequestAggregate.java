package com.letsellify.logistics.components.logistics.core.logisticRequestManagement.eventStore.aggregate;

import com.letsellify.logistics.components.logistics.core.logisticRequestManagement.data.*;
import com.letsellify.logistics.components.logistics.core.logisticRequestManagement.eventStore.command.*;
import com.letsellify.logistics.components.logistics.core.logisticRequestManagement.eventStore.event.*;
...
public class LogisticRequestAggregate {
    ...
    public void onLogisticRequestedEvent(final LogisticRequestedEvent event) {
        ...
        this.item = new Item(event.getItemName(), event.getQuantity(), event.getDescription(), event.getFragility(), event.getWeight(), event.getCondition().stream().map(ItemCondition::new).collect(Collectors.toSet()));
