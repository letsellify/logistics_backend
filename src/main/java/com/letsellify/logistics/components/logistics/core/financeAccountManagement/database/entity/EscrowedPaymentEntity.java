...
public class EscrowedPaymentEntity extends Auditable {
    ...
    public static EscrowedPaymentEntity getInstance (final LogisticsAccountEntity account, final BigDecimal totalAmount, final UUID shippingId) {
    ...
    protected void settle(final String userEmail, final LogisticsAppRole userRole, final BigDecimal amount) {
