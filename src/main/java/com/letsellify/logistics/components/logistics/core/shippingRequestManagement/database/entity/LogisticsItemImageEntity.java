...
public class LogisticsItemImageEntity extends Auditable {
    @Id
    private String id;
    ...
    private LogisticsRequestEntity logisticsRequest;

    protected LogisticsItemImageEntity() {
        super();
    }

    public LogisticsItemImageEntity (final String userEmail, final String imageFilePath) {
        super();
        this.id = this.generateImageId(imageFilePath);
        this.imageFilePath = imageFilePath;
        this.vendorUsername = userEmail;
    }
