...
import com.letsellify.logistics.components.logistics.core.logisticRequestManagement.rest.resource.LogisticRequestResource;
...
public final class LogisticRequest {
    ...
    private final LogisticDispatcher dispatcher;

    private final LogisticAgent agent;
...
//    }
    ...
    public LogisticRequest(final @NonNull LogisticRequestEntity entity, final @NonNull List<String> imagesPresignedUrl, final Sender sender, final LogisticDispatcher dispatcher, final  LogisticAgent agent) {
        this.id = entity.getId();
        this.shippingRequestId = entity.getShippingRequestId();
    ...
    public FullLogisticRequestResource getResource() {
        return LogisticRequestDataMapper.INSTANCE.dataToResource(this);
    }

    public LogisticRequestResource getVendorResource() {
