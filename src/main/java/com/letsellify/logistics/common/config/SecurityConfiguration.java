...
import com.letsellify.logistics.common.security.config.keys.RefreshTokenRsaKey;
import com.letsellify.logistics.common.security.data.LogisticsAppSecurityUser;
import com.letsellify.logistics.components.user.core.socialSignupAndLoginManagement.config.OAuth2LoginSuccessHandler;
...
public class SecurityConfiguration {
    ...
    private static final String[] AUTH_WHITELIST = {
            "/",
            "/dashboard/**", // Allow dashboard endpoints (role selection, success page)
            "/oauth2/**",
            "/login/oauth2/code/**",
            "/api/v1/authorize/**",
    ...
    public OAuth2LoginSuccessHandler oAuth2LoginSuccessHandler() {
        return new OAuth2LoginSuccessHandler(
          this.userManager,
          this.tokenManagerProvider.getIfAvailable(),
          this.objectMapper
        );
    }
...
//    @Bean
//    public OAuth2LoginSuccessHandler oAuth2LoginSuccessHandler() {
//        return new OAuth2LoginSuccessHandler(this.userManager, this.tokenManager, this.objectMapper);
//    }
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:4200", "http://127.0.0.1:4200", "http://localhost:5173", "http://127.0.0.1:5173", "http://letsellify.com", "https://letsellify.com", "http://api.logistics.letsellify.com", "https://api.logistics.letsellify.com", "https://logistics.letsellify.com/"));
